...
public class UserGuessingGame {
	...
	public static void main(String[] args) {
		...
		System.out.println("I've picked a number between 0 and 100. Try to guess what it is! How many guesses do you think you'll take?: ");
		int num_of_tries = in.nextInt();
